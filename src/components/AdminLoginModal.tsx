        ...
        <div className="px-2 pb-6">
          ...
          <form onSubmit={handleLogin} className="space-y-6 max-w-sm mx-auto">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder={loginType === 'email' ? 'you@example.com' : 'Enter username...'}
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              <p className="text-sm font-medium">Demo Login Credentials:</p>
              {loginType === 'email' ? (
                <>
                  <p className="text-sm text-muted-foreground">
                    Email: <code className="bg-background px-2 py-0.5 rounded text-xs">user@example.com</code>
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Password: <code className="bg-background px-2 py-0.5 rounded text-xs">user123</code>
                  </p>
                </>
              ) : (
                <>
                  <p className="text-sm text-muted-foreground">
                    Username: <code className="bg-background px-2 py-0.5 rounded text-xs">admin</code>
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Password: <code className="bg-background px-2 py-0.5 rounded text-xs">admin123</code>
                  </p>
                </>
              )}
            </div>
