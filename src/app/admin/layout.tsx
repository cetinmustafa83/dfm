...
const navItems = [
  ...
  { name: 'Frontend', href: '/admin/frontend', icon: Monitor },
  { name: 'Customers', href: '/admin/customers', icon: Users },
  { name: 'Project Requests', href: '/admin/project-requests', icon: Briefcase },
  { name: 'Packages', href: '/admin/packages', icon: ShoppingBag },
  { name: 'Payments & Invoices', href: '/admin/payments', icon: Euro },
  { name: 'Marketplace', href: '/admin/marketplace', icon: Layers },
