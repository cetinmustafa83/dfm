              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <select
                    ...
                    className="w-full h-10 rounded-md border border-input bg-background px-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    disabled={!activePackage?.features.prioritySupport}
                  >
                    <option value="low">Low</option>
                    <option value="medium">Medium</option>
                    {activePackage?.features.prioritySupport && <option value="high">High</option>}
                  </select>
                  {!activePackage?.features.prioritySupport && (
                    <p className="text-xs text-muted-foreground">
